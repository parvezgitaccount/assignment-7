    ...
    return (
        <div>
            <nav className="navbar navbar-expand-lg navbar-white  bg-dark">
                <a className="navbar-brand" href="/navbar">Global It Limited</a>
            ...
            <div className = 'header container-fluid'>
                <h1>WelCome to Online's Courses</h1>
                <h5>Web Development relates to <span> DevelopmentIT & SoftwareWeb Development</span></h5>
            </div>
        </div>
    );
};
